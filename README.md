...
|---------|-------|:---------------------:|:---------:|
| **Session 1** | Introduction to NLP & Emotion Detection | [Download ↓](../../releases/tag/session-1-documentation) | N/A |
| **Session 2** | Text as Data: Preprocessing & Normalisation | [Download ↓](../../releases/tag/session-2-documentation) | — |
